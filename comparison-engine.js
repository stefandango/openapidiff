/**
 * ComparisonEngine — pure-logic comparison of two OpenAPI/Swagger specifications.
 *
 * This class has zero DOM dependencies and can be used independently of the UI.
 * It takes two parsed spec objects, runs a deep comparison, and returns an array
 * of change objects describing the differences.
 *
 * Usage:
 *   const engine = new ComparisonEngine(spec1, spec2);
 *   const changes = engine.compare();
 */
class ComparisonEngine {
    ...
    // -------------------------------------------------------
    // Response and schema comparison
    // -------------------------------------------------------
